...
def run_exp(num_trial, K, T, d, s0, l, algs):
...
def main():
    ...
    trajectories = run_exp(args.num_trial, K, T, d, s0, l, algs)

    # save log
    for i in range(len(algs)):
        save_path = 'log/elliptical/K{}_d{}_s{}_l{}/{}/'.format(K, d, s0, l, algs[i][0].__name__)
