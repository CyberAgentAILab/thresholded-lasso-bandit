...
def run_exp(num_trial, K, T, d, s0, x_max, rho_sq, algs):
...
def main():
    ...
    trajectories = run_exp(args.num_trial, K, T, d, s0, x_max, rho_sq, algs)

    # save log
    for i in range(len(algs)):
        save_path = 'log/gaussian/K{}_d{}_s{}_xm{}_rho{}/{}/'.format(K, d, s0, x_max, rho_sq, algs[i][0].__name__)
